...
OBJS            = $(PRG).o hd44780.o si4734.o lm73_functions_skel.o twi_master.o uart_functions.o

SRCS            = $(PRG).c  hd44780.c si4734.c lm73_functions_skel.c twi_master.c uart_functions.c
